...
const NavMenu = ({onAppStateChange, links, app}:
  {onAppStateChange: Function, links: ILink[], app: string
})  => {
        ...
        <div className='py-5 flex items-center justify-between'>
          ...
          <nav>
            <ul className='flex items-center gap-4 text-neutral-600'>
              ...
              <li className='cursor-pointer' onClick={() => onAppStateChange(appSwitch)}> Reach {appSwitch}</li>
            </ul>
          </nav>
        </div>
      </PaddingContainer>
